...
<div class="wrapper" id="app">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <!-- SEARCH FORM -->
    {{-- The form will make us refresh our page everytime, so we commented it out --}}
    {{-- <form class="form-inline ml-3"> --}}
      <div class="input-group input-group-sm">
        {{-- when someone press enter, query the database --}}
        ...
        {{-- when someone press any keyword, query the database --}}
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('img/tree.svg') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('img/star.svg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
